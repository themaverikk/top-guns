...
const RadioButtonQuestion = ({ question, handleChange }) => {
  return (<div key={question.name}>
    <FormLabel component="legend" style={{ fontSize: '1.5rem' }}>{question.text}</FormLabel>
              ...
              <div style={{
                ...
                <form onSubmit={handleSubmit}>
                  <FormControl component="fieldset" error={error}>
                    ...
                    {error && (
                      <FormHelperText style={{ fontSize: 'medium' }}>Please answer all the questions</FormHelperText>
                    )}
